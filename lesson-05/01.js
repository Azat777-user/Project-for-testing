...
3. Если ресурс существует, метод должен добавлять значение `amount` к текущему количеству этого ресурса 
в объекте.
*/
...
const game = {
  ...
  addResource(resource, amount) {
    if(!this.resources[resource]) {console.log("Invalid resource")}
    else {this.resources[resource] += amount}
  }
}
