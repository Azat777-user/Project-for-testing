/*
  ...
  При возникновении сложностей можете ознакомиться с пошаговым планом реализации ниже, 
  но лучше попробовать сначала самостоятельно 🧙‍♂️
...
const model = {
  ...
  // your code
  deleteTask(taskId){
    this.movies = this.movies.filter(task => task.id !== taskId)
